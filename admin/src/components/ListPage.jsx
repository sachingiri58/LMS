...
import { BookOpen, Clock, Eye, EyeClosed, Search, Star, StarHalf, Trash2, Video } from "lucide-react";
...
const ListPage = () => {
  ...
  {/**filter the course (by name, instructor, category of the classes  ) */ }
    ...
    <div className={listStyles.pageContainer} >
      ...
      <div className={listStyles.contentContainer}>
        <div className={listStyles.headerContainer}>
          <h1 className={listStyles.headerTitle}>Course Catelong</h1>

          <p className={listStyles.headerSubtitle}>
            Manage and browse your courses -clean, light and
          </p>
        </div>
        ...
        <div className={listStyles.searchContainer}>
          <div className={listStyles.searchInputContainer}>
            ...
            <input type="text" placeholder="serach courses, instructors, or categories.."
              value={searchTerm}
        ...
        <div className={listStyles.courseList}>
          {loading && (
            <div className={listStyles.emptyText}>
              Loading Courses...
            </div>
          )}
          ...
          {!loading &&
                          ...
                          >
                            <div className={listStyles.lectureHeader}>
                              ...
                              >
                                ...
                                {expandedLectures[`${course.id}-${lecture.id || lecture._id}`] ? (
                                  <Eye className={listStyles.actionIcon} />
                                ) : (
                                  <EyeClosed className={listStyles.actionIcon} />
                                )}
            ...
            {!loading && filteredCourses.length === 0 &&(
              ...
              <p className={listStyles.emptyText}> No courses found </p>
              <button onClick={()=>setSearchTerm("")} className={listStyles.clearButton}> Clear Search </button>
              </div>
            )}
        </div>
      </div>
